...
export const data: Data = {
  ...
  subtitle: `ฉันหลงใหลในเทคโนโลยีและข้อมูลอย่างลึกซึ้ง ฉันปรารถนาที่จะเรียนรู้สิ่งใหม่ ๆ และแบ่งปันความหลงใหลของฉันผ่านการเขียนโค้ด คำขวัญของฉันคือ "ถ้าใครทำได้ ฉันก็ทำได้" ปู่ของฉันส่งต่อบทเรียนนี้ให้กับแม่และฉัน และบทเรียนนี้ก็ยังคงอยู่กับฉันนับตั้งแต่นั้นเป็นต้นมา ฉันตั้งใจทำงานทุกวันเพื่อพัฒนาทักษะการเขียนโค้ด
   <br/>
   <br/>
   ฉันกำลังมองหาโครงการที่น่าตื่นเต้น "มาสร้างสิ่งที่น่าทึ่งด้วยกัน!"`,
  address:
