...
export const defaultDescription =
  "Portfolio of Napatchol Thaipanich, a full-stack developer in Bangkok building practical web systems, AI-enabled products, and secure platforms.";
export const siteUrl = "https://patorsiang.github.io";
