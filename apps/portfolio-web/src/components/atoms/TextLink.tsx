...
export function TextLink({ href, children, className, target, rel }: TextLinkProps) {
  ...
  const sharedClassName = classNames(
    "font-semibold text-[var(--color-accent)] underline-offset-4 transition hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-focus)] print:text-zinc-800",
    className,
  );
