...
export function Navbar({ handle, name, role, headline, links }: NavbarProps) {
  return (
    <header className="flex flex-col gap-8 border-b border-[var(--color-border)] pb-10 lg:flex-row lg:items-end lg:justify-between">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-xl font-medium text-[var(--color-text-muted)]">{role}</p>
